...
- Name: admin-products.spec.ts >> 관리자 상품 관리 플로우 >> 새 상품 등록 및 카테고리/이미지/옵션 설정
- Location: e2e/admin-products.spec.ts:20:9
...
Call log:
  - waiting for locator('button:has-text("새 상품 등록")')
        ...
        - table [ref=e23]:
          ...
          - rowgroup [ref=e32]:
            - row "아크릴 키링 핸드메이드 아크릴 플라워 키링 8,900원 150개 6/30/2026 수정 삭제" [ref=e33]:
              ...
              - cell "수정 삭제" [ref=e39]:
                - button "수정" [ref=e40] [cursor=pointer]
